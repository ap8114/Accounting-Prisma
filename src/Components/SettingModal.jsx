...
const SettingModal = ({ show, handleClose }) => {
  ...
  const topbarColors = [
    "#343a40", "#0d6efd", "#6610f2", "#6366f1", "#032d45", "#6f42c1",
    "#d63384", "#198754", "#ff5733", "#ffc300", "#28a745", "#20c997",
    "#17a2b8", "#fd7e14", "#6c757d", "#0dcaf0", "#ff6b6b", "#845ec2",
    "#2c73d2", "#0081cf", "#0089ba", "#008e9b", "#00c9a7", "#4b4453"
  ];

  const sidebarColors = [
    "#343a40", "#0d6efd", "#6610f2", "#6366f1", "#032d45", "#6f42c1",
    "#d63384", "#198754", "#ffbe0b", "#fb5607", "#ff006e", "#8338ec",
    "#3a86ff", "#06d6a0", "#118ab2", "#073b4c", "#ef476f", "#ffd166",
    "#06d6a0", "#26547c", "#fffcf2", "#ccc5b9", "#403d39", "#252422"
  ];
    ...
    <Offcanvas show={show} onHide={handleClose} placement="end">
      ...
      <Offcanvas.Body>
        ...
        <div className="mt-4">
          ...
          <div className="mb-4 mt-3 d-flex align-items-center gap-2">
            <input
              type="color"
              value={topbarColor}
        ...
        <div className="mt-4">
          <h6 className="fw-semibold">Sidebar Hover Color</h6>
          <div className="d-flex flex-wrap gap-2 mt-2">
            {sidebarColors.map((color) => (
              <div
                key={color}
        ...
        {/* <div className="mt-4">
          <h6 className="fw-semibold">Button Color</h6>

          <div className="d-flex flex-wrap gap-2 mt-2">
            {sidebarColors.map((color) => (
              <div
                key={color}
                className={`color-box rounded ${buttonColor === color ? "border border-dark border-2" : ""}`}
                style={{ backgroundColor: color, width: "30px", height: "30px", cursor: "pointer" }}
                onClick={() => updateButtonColor(color)}
              />
            ))}
          </div>
